  ...
  return (
    <div className="flex flex-1 flex-col lg:flex-row">
      ...
      <div className="relative flex-1 h-[calc(100vh-56px)]">
        ...
        <Link
          href="/nearby"
          className="absolute top-4 left-1/2 z-20 -translate-x-1/2 rounded-full bg-green-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg hover:bg-green-700 transition-colors"
        >
          내 주변 양심병원 바로 찾기
        </Link>
